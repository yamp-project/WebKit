...
if (NOT DEFINED ENABLE_WEBKIT_LEGACY)
...
option(ENABLE_NETWORKING "Enable networking features (CURL, OpenSSL)" OFF)
option(ENABLE_TEXT_RENDERING "Enable advanced text rendering (HarfBuzz)" OFF)
option(ENABLE_INTL "Enable internationalization support (ICU)" OFF)
option(ENABLE_IMAGE_FORMATS "Enable image format support (JPEG, PNG, WebP)" OFF)
option(ENABLE_XML_SUPPORT "Enable XML parsing support" OFF)
option(ENABLE_DATABASE "Enable database support (SQLite)" OFF)
option(ENABLE_GRAPHICS "Enable graphics features (ANGLE, texture mapping)" OFF)
option(ENABLE_THEMING "Enable UI theming support" OFF)
...
if (ENABLE_TEXT_RENDERING AND USE_WOFF2)
